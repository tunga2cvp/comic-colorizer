...
model_rgb = tf.keras.models.load_model(model_name_1)
model_color_rgb = tf.keras.models.load_model(model_name_2)
...
def predict_mode_3(color_mode=True, color_space='rgb', color=None, filename=None):
    output, y_img = colorize_page(model_color_rgb, roi_ls, resnet=resnet, color_space=color_space, color_mode=color_mode, src_color=color)
