...
# Get output of pretrained backbone model
...
# Extract color from input image (use during training)
...
# Calculate IoU of overlapping rectangles
...
# Extract panels (Region of Interest - ROI)
...
# Transform ROI from image into batch
